...
public class ConsolaOlimpicos
{
	...
	private void ejecutarPaisDeUnAtleta() {
		System.out.println("\npais de un atleta\n");
		String atleta = this.input("Por favor ingrese el nombre de un atleta");
	    String pais = this.calculadora.paisdeunatleta(atleta);
		if (pais == null) {
		   System.out.println("No se a encontrado el atleta ");
		} else {
		   System.out.println("El atleta pertenece a " + pais);
		}
	}
